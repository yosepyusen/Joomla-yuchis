...
<style>
   ...
   .ark.navbar .nav > li > a {
	...
	.ark.navbar {position: fixed;min-width:340px; width: auto;top:45%;right:-340px;z-index:1001;display: block;}
 ...
 <div class="ark navbar" id="ark-navbar">
    <div class="navbar-inner">
		 <ul class="nav">
			...
			<li class="save"><a href="javascript:void(0);"><span class="glyphicon glyphicon-floppy-saved"></span><span class="title"><?php echo JText::_('JSAVE'); ?></span></a></li>
			<li class="article">
				<a href="<?php echo JRoute::_($links['newarticle']);?>" target="_blank"><span class="glyphicon glyphicon-plus-sign"></span><span><?php echo JText::_('JNEW'); ?></span></a>
			</li>
			<li class="disable"><a href="javascript:void(0);"><span class="glyphicon glyphicon-off"></span><span class="title"><?php echo JText::_('JDISABLED'); ?></span></a></li>
			</ul>
	 </div>
 </div>
    ...
    (function ($) //navbar slider
    {
        $(function () {
           ...
           var start,
             ...
             setTimeout(function()
            {
                start = ARK.sidebar.start = $('.ark .navbar-inner').innerWidth() - $('.ark .navbar-inner li.logo').innerWidth();
                start = "-" + start + "px";
                end = ARK.sidebar.end = $('.ark .navbar-inner').innerWidth() - ($('.ark .navbar-inner li.logo').innerWidth() + $('.ark .navbar-inner li.save').innerWidth() + $('.ark .navbar-inner li.article').innerWidth() + $('.ark .navbar-inner li.disable').innerWidth());
                end = "-" + end + "px";

                $('.ark .navbar-inner').parent().animate({ right: start }, { queue: false, duration: 500 });
            }, 500);
            $(".ark .nav .logo a").on('click', function () {
                if ($(".ark .navbar-inner").parent().css("right") == start) {
                    $(".ark .navbar-inner").parent().animate({ right: end }, { queue: false, duration: 500 });
                } else {
                    $(".ark .navbar-inner").parent().animate({ right: start }, { queue: false, duration: 500 });
                }
            });
    ...
    (function ($) {
        ...
        function execute(toggleNativeLinks) {
            ...
            if (CKEDITOR.enableManualInline) {
                ...
                $('li.disable a').children('.title').html('<?php echo JText::_("JENABLED"); ?>');
                var start = ARK.sidebar.start = $('.ark .navbar-inner').innerWidth() - $('.ark .navbar-inner li.logo').innerWidth();
                start = "-" + start + "px";
                var end = ARK.sidebar.end = $('.ark .navbar-inner').innerWidth() - ($('.ark .navbar-inner li.logo').innerWidth() + $('.ark .navbar-inner li.save').innerWidth() + $('.ark .navbar-inner li.article').innerWidth() + $('.ark .navbar-inner li.disable').innerWidth());
                end = "-" + end + "px";

                $(".ark .navbar-inner").parent().css("right",end);

                $('#ark-navbar li span.arkicon-arkeditor').toggleClass('arkicon-disable', false);
                ...
                $('li.disable a').children('.title').html('<?php echo JText::_("JDISABLED"); ?>');
                var start = ARK.sidebar.start = $('.ark .navbar-inner').innerWidth() - $('.ark .navbar-inner li.logo').innerWidth();
                start = "-" + start + "px";
                var end = ARK.sidebar.end = $('.ark .navbar-inner').innerWidth() - ($('.ark .navbar-inner li.logo').innerWidth() + $('.ark .navbar-inner li.save').innerWidth() + $('.ark .navbar-inner li.article').innerWidth() + $('.ark .navbar-inner li.disable').innerWidth());
                end = "-" + end + "px";
                ...
                $(".ark .navbar-inner").parent().css("right",end);
                $('#ark-navbar li span.arkicon-arkeditor').toggleClass('arkicon-disable', true);
                url = 'index.php?option=com_ajax&plugin=inlinemodestatelistener&format=json&state=1';
                $.get(url, function (response) { });
            };
        }

        $('li.disable a').on('mousedown : click', function (event) {
