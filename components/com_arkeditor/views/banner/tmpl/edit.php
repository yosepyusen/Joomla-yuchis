...
<form action="<?php echo JRoute::_('index.php?option=com_arkeditor&view=banner&layout=edit&id=' . (int) $this->item->id).$modal; ?>" method="post" name="adminForm" id="banner-form" class="form-validate">
