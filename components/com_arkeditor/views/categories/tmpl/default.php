...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_arkeditor&task=categories.saveOrderAjax&tmpl=component';
...
?>
<form action="<?php echo JRoute::_('index.php?option=com_arkeditor&view=categories'.$modal); ?>" method="post" name="adminForm" id="adminForm">
