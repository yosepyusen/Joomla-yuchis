...
?>
<form action="<?php echo JRoute::_('index.php?option=com_arkeditor&view=banners'.$modal); ?>" method="post" name="adminForm" id="adminForm">
			...
			<table class="table table-striped" id="articleList">
				...
				<tbody>
					<?php foreach ($this->items as $i => $item) :
						...
						$item->cat_link = JRoute::_('index.php?option=com_categories&extension=com_banners&task=edit&type=other&cid[]=' . $item->catid.$modal);
						...
						<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->catid; ?>">
							...
							<td class="nowrap has-context">
								<div class="pull-left">
									...
									<?php endif; ?>
									<?php if ($canEdit) : ?>
										<a href="<?php echo JRoute::_('index.php?option=com_arkeditor&task=banner.edit&id=' . (int) $item->id).$modal; ?>">
