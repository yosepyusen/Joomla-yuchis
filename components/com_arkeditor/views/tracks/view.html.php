...
JLoader::register('ArkeditorHelper', JPATH_COMPONENT. '/helpers/arkeditor.php');
 ...
 * @since  1.6
 */
class ArkeditorViewTracks extends JViewLegacy
{
	/**
	 * An array of items
	 *
	...
	public function display($tpl = null)
	{
		...
		ArkeditorHelper::addSubmenu('tracks');
	...
	protected function addToolbar()
	{
		...
		JHtmlSidebar::setAction('index.php?option=com_arkeditor&view=tracks');
	}
