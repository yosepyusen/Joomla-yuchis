 ...
 * @since  1.6
 */
class ArkeditorControllerBanners extends JControllerAdmin
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'Banner', $prefix = 'ArkeditorModel', $config = array('ignore_request' => true))
	{
	...
	public function sticky_publish()
	{
		...
		$this->setRedirect('index.php?option=com_arkeditor&view=banners');
	}
}
