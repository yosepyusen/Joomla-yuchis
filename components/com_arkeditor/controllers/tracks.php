 ...
 * @since  1.6
 */
class ArkeditorControllerTracks extends JControllerLegacy
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'Tracks', $prefix = 'ArkeditorModel', $config = array('ignore_request' => true))
	{
	...
	public function delete()
	{
		...
		$this->setRedirect('index.php?option=com_arkeditor&view=tracks');
	}
}
