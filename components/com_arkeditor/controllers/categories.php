 ...
 * @since  1.6
 */
class ArkeditorControllerCategories extends JControllerAdmin
{
	/**
	 * Proxy for getModel
	 *
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'Category', $prefix = 'ArkeditorModel', $config = array('ignore_request' => true))
	{
	...
	public function rebuild()
	{
		...
		$this->setRedirect('index.php?option=com_arkeditor&view=categories');
	...
	public function checkin()
	{
		...
		$redirectUri = 'index.php?option=com_arkeditor&view=categories',
		$this->setRedirect($redirectUri, $this->message, $this->messageType);
