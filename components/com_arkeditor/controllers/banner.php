 ...
 * @since  1.6
 */
class ArkeditorControllerBanner extends JControllerForm
{
	/**
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('Banner', 'ArkeditorModel', array());

		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_arkeditor&view=banners' . $this->getRedirectToListAppend(), false));
