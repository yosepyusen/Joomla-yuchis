...
"checked_out_time" timestamp NOT NULL default '1970-01-01 00:00:00+00',
"iscore" int NOT NULL default '0',
"acl" text NULL,
"params" text NOT NULL,
"parentid" int NULL,
PRIMARY KEY ("id"),
CONSTRAINT "#__ark_editor_plugins_idx_name" UNIQUE ("name")
);
...
"parentid" int NULL,
PRIMARY KEY ("id"),
CONSTRAINT "#__update_ark_editor_plugins_idx_name" UNIQUE ("name")
) ;
...
(74,'Format','format','plugin',3,1,1,'',0,'',NULL),
...
"params" text NOT NULL,
PRIMARY KEY ("id"),
CONSTRAINT "#__ark_editor_toolbars_idx_name" UNIQUE ("name")
) ;
...
(1,'Back','back',1,0,'1970-01-01 00:00:00+00',1,'{"show_new":"0","show_save":"0","components":[]}'),
(2,'Front','front',1,0,'1970-01-01 00:00:00+00',1,'{"show_versions":"0","show_new":"0","show_save":"0","show_undo":"0","show_redo":"0","show_find":"0","show_close":"0","show_source":"0","show_design":"0","show_blocks":"0","components":[]}'),
(3,'Inline','inline',1,0,'1970-01-01 00:00:00+00',1,'{"show_versions":"0","show_new":"0","show_save":"0","show_undo":"0","show_redo":"0","show_find":"0","show_close":"0","show_source":"0","show_design":"0","show_blocks":"0","components":[]}'),
(4,'Title','title',1,0,'1970-01-01 00:00:00+00',1,'{"show_versions":"0","show_new":"0","show_save":"0","show_undo":"0","show_redo":"0","show_find":"0","show_close":"0","show_source":"0","show_design":"0","show_blocks":"0","components":[]}'),
(5,'Mobile','mobile',1,0,'1970-01-01 00:00:00+00',1,'{"show_versions":"0","show_new":"0","show_save":"0","show_undo":"0","show_redo":"0","show_find":"0","show_close":"0","show_source":"0","show_design":"0","show_blocks":"0","components":[]}'),
(6,'Image','image',1,0,'1970-01-01 00:00:00+00',1,'{"show_versions":"0","show_new":"0","show_save":"0","show_undo":"0","show_redo":"0","show_find":"0","show_close":"0","show_source":"0","show_design":"0","show_blocks":"0","components":[]}');


INSERT INTO #__ark_editor_toolbars (title,name,published,checked_out,checked_out_time,iscore,params)
SELECT 'Full','full',1,0,'1970-01-01 00:00:00+00',1,'{"show_new":"0","show_save":"0","components":[]}' 
WHERE NOT EXISTS(SELECT 1 FROM #__ark_editor_toolbars p WHERE name = 'full');
...
UNION
SELECT 'Custom Field','com_fields.fields' ,'{"special":{"dbtable":"#__fields","key":"id","type":"Field","prefix":"FieldsTable"}}','' ,'', '','{"formFile":"administrator\\/components\\/com_fields\\/models\\/forms\\/field.xml", "hideFields":["asset_id","checked_out","checked_out_time","required","context","params","fieldparams","language","created_time","ordering","modified_time","modified_by","created_user_id","note","description","state"],"ignoreChanges":["checked_out", "checked_out_time"],"convertToInt":["publish_up", "publish_down", "showtitle", "ordering","access"] ,"displayLookup":[{"sourceColumn":"access","targetTable":"#__viewlevels","targetColumn":"id","displayColumn":"title"},{"sourceColumn":"group_id","targetTable":"#__fields_groups","targetColumn":"id","displayColumn":"title"} ]}'
WHERE NOT EXISTS(SELECT 1 FROM #__content_types WHERE "type_alias" IN ('com_modules.custom', 'com_fields.fields'));