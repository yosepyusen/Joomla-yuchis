...
if ($this->itemnext[0] || $this->itemprev[0]) {
	...
	if($this->itemprev[0]) {
		...
		echo '<div class="pull-left"><a href="'.$linkPrev.'" class="btn btn-default ph-item-navigation" role="button" title="'.$titleT.'"><span class="glyphicon glyphicon-arrow-left"></span></a></div>';
	}
	echo '</div>';
	...
	if($this->itemnext[0]) {
		...
		echo '<div class="pull-right"><a href="'.$linkNext.'" class="btn btn-default ph-item-navigation" role="button" title="'.$titleT.'"><span class="glyphicon glyphicon-arrow-right"></span></a></div>';
	}
	echo '</div></div>';
}
