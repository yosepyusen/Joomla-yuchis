...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2itemsblock k2itemsblock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
    ...
    <li class="<?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>">
      ...
      <div class="moduleitemintroimage">
	      ...
	      <a class="moduleitemimage" href="<?php echo $item->link; ?>" title="<?php echo JText::_('K2_CONTINUE_READING'); ?> &quot;<?php echo K2HelperUtilities::cleanHtml($item->title); ?>&quot;">
	      	<img src="<?php echo $item->image; ?>" class="img-responsive" alt="<?php echo K2HelperUtilities::cleanHtml($item->title); ?>" />
	      </a>
	      <?php endif; ?>
      </div>
  ...
  <div class="k2itemfooter">
      ...
      <span class="moduleitemdatecreated"><?php echo JText::_('K2_WRITTEN_ON'); ?> <?php echo JHTML::_('date', $item->created, JText::_('K2_DATE_FORMAT_LC2')); ?></span><?php endif; ?><?php if($params->get('itemCategory')): ?><a class="moduleitemcategory" href="<?php echo $item->categoryLink; ?>"> <?php echo JText::_('K2_IN'); ?> <?php echo $item->categoryname; ?></a>
      <?php endif; ?>
