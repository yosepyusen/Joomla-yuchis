...
<div id="k2wrapper">
<div id="k2Container" class="col-sm-12 itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?> detailview">
	...
	<?php echo $this->item->event->K2BeforeDisplay; ?>
		...
		<!-- Item Image -->
		<div class="itemImageBlock k2imgblock">
	...
	<div class="itemBody itembody">
	<?php if($this->item->params->get('itemTitle')): ?>
	<!-- Item title -->
	<h2 class="itemTitle itemtitle">
...
<div class="pull-left k2links">
	...
	<div class="itemToolbar itemtoolbar pull-right">		
	<?php if(
	...
	<?php if(!empty($this->item->fulltext)): ?>
		...
		<!-- Item tags -->
		<div class="itemTagsBlock k2tags">
			<span><?php echo JText::_('K2_TAGGED_UNDER'); ?></span>
			<ul class="itemTags">
				<?php foreach ($this->item->tags as $tag): ?>
				<li><a class="label label-info" href="<?php echo $tag->link; ?>"><?php echo $tag->name; ?></a></li>
				<?php endforeach; ?>
			</ul>
			<div class="clr"></div>
		</div>
...
<div class="container-fluid">
	...
	<div class="pull-right k2rating">
		...
		<div class="itemRatingForm">
			...
			<div id="itemRatingLog<?php echo $this->item->id; ?>" class="itemRatingLog itemratinglog"><?php echo $this->item->numOfvotes; ?></div>
			<div class="clr"></div>
		</div>
		<div class="clr"></div>
	</div>
	...
	<!-- Author Block -->
	<div class="itemAuthorBlock k2author">
		<?php if($this->item->params->get('itemAuthorImage') && !empty($this->item->author->avatar)): ?>
		<img class="itemAuthorAvatar itemauthoravatar" src="<?php echo $this->item->author->avatar; ?>" alt="<?php echo K2HelperUtilities::cleanHtml($this->item->author->name); ?>" />
		<?php endif; ?>

		<div class="itemAuthorDetails">
			<h3 class="itemAuthorName itemauthorname">
				<a rel="author" href="<?php echo $this->item->author->link; ?>"><?php echo $this->item->author->name; ?></a>
			</h3>
	...
	<div class="itemAuthorLatest itemauthorlatest">
	...
	*/
	...
	<div class="itemRelated itemrelated">
