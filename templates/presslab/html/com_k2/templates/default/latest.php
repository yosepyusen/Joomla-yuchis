...
<div id="k2Container" class="latestview latestView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="latestItemsContainer" style="width:<?php echo number_format(100/$this->params->get('latestItemsCols'), 1); ?>%;">
		...
		<div class="catlatest">
			...
			<div class="latestItemsCategoryImage lastcatimage">
				<img class="img-responsive" src="<?php echo $category->image; ?>" alt="<?php echo K2HelperUtilities::cleanHtml($category->name); ?>" />
			<?php endif; ?>
		...
		<!-- Start K2 User block -->
		<div class="latestItemsUser latestitemsuser">
		...
		<!-- Start Items list -->
		<div class="latestItemList latestitemlist">
			...
			<?php else: ?>
			<h2 class="latestItemTitleList latestitemtitlelist">
