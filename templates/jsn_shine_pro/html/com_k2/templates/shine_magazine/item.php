...
<div id="k2Container" class="itemView item-magazine<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
		...
		<ul>
			...
			<li>
				<a class="itemPrintLink" rel="nofollow" href="<?php echo $this->item->printLink; ?>" onclick="window.open(this.href,'printWindow','width=900,height=600,location=no,menubar=no,resizable=yes,scrollbars=yes'); return false;">
					<span><i class="fa fa-print" aria-hidden="true"></i><?php //echo JText::_('K2_PRINT'); ?></span>
				</a>
			</li>
			<?php endif; ?>
			...
			<li>
				<a class="itemEmailLink" rel="nofollow" href="<?php echo $this->item->emailLink; ?>" onclick="window.open(this.href,'emailWindow','width=400,height=350,location=no,menubar=no,resizable=no,scrollbars=no'); return false;">
					<span><i class="fa fa-envelope-o" aria-hidden="true"></i><?php //echo JText::_('K2_EMAIL'); ?></span>
				</a>
			</li>
			<?php endif; ?>
	...
	<div class="itemBody">
		...
		<?php if($this->item->params->get('itemImage') && empty($this->item->video)): ?>
		<!-- Item Image -->
		<div class="itemImageBlock">
			<span class="itemImage">
				<a data-k2-modal="image" href="<?php echo $this->item->imageXLarge; ?>" title="<?php echo JText::_('K2_CLICK_TO_PREVIEW_IMAGE'); ?>">
					<img src="<?php if(!empty($this->item->image)) { echo $this->item->image; } else { echo 'http://placehold.it/869x436/28272c/ffffff?text=JSN+SHINE+NO+IMAGE'; } ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" />
				</a>
			</span>
	...
	<div class="itemNavigation">
		...
		<div class="itemPrevious">
			<a href="<?php echo $this->item->previousLink; ?>"><i class="fa fa-long-arrow-left"></i> <?php echo $this->item->previousTitle; ?></a>
			<span><?php echo JText::_('K2_PREVIOUS_POST'); ?></span>
		</div>
		<?php endif; ?>

		<?php if(isset($this->item->nextLink)): ?>
		<div class="itemNext">
			<a href="<?php echo $this->item->nextLink; ?>"><?php echo $this->item->nextTitle; ?> <i class="fa fa-long-arrow-right"></i></a>
			<span><?php echo JText::_('K2_NEXT_POST'); ?></span>
		</div>
		<?php endif; ?>
	</div>
	<?php endif; ?>
