...
<div id="k2Container" class="userView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="userItemList">
		<?php
			$col_users = 3;
			$col_users_class = 12 / $col_users;
		?>
		<div  class="row">
			<?php foreach ($this->items as $key=>$item): ?>
			<div class="col-lg-<?php echo $col_users_class; ?> col-md-<?php echo $col_users_class; ?> col-sm-<?php echo $col_users_class; ?> col-xs-12">
