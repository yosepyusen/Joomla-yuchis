...
<div id="k2Container" class="itemView item-portfolio<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemExtraFields row">
		...
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 type<?php echo ucfirst($extraField->type); ?> group<?php echo $extraField->group; ?>">
			<?php if($extraField->type == 'header'): ?>
			<h4 class="itemExtraFieldsHeader"><?php echo $extraField->name; ?></h4>
			<?php else: ?>
			<div class="itemExtraFieldsLabel"><strong><?php echo $extraField->name; ?></strong></div>
			<div class="itemExtraFieldsValue"><?php echo $extraField->value; ?></div>
			<?php endif; ?>
		</div>
		<?php endif; ?>
		<?php endforeach; ?>
	...
	<!-- Author Block -->
	<div class="itemAuthorBlock hidden">
	...
	<div class="itemAuthorLatest hidden">
