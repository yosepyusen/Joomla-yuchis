...
<div id="fd" class="eb eb-mod mod_easyblogmostpopularpost videolarge <?php echo $params->get('moduleclass_sfx'); ?> eb-responsie">

    <?php if ($posts) { ?>
    <div class="eb-mod<?php if ($layout == 'horizontal') { echo " mod-items-grid clearfix"; } ?>">
        <?php foreach ($posts as $post) { ?>
            <?php require(JModuleHelper::getLayoutPath('mod_easyblogmostpopularpost', 'videolarge_item')); ?>
        <?php } ?>
    </div>
    <?php } else { ?>
