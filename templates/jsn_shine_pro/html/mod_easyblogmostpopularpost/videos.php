            ...
            <?php
                ...
                foreach ($posts as $post) {
                    ...
                    if ( $i == 0 ) {
                        ...
                        require(JModuleHelper::getLayoutPath('mod_easyblogmostpopularpost', 'videos_item'));

                    }else {

                        require(JModuleHelper::getLayoutPath('mod_easyblogmostpopularpost', 'videos_itemlist'));
