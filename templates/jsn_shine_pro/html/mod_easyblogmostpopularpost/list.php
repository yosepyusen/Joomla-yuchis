...
<div id="fd" class="eb eb-mod mod_easyblogmostpopularpost <?php echo $params->get('moduleclass_sfx'); ?> eb-responsie list">

    <?php if ($posts) { ?>
    <div class="eb-mod<?php if ($layout == 'horizontal') { echo " mod-items-grid clearfix"; } ?>">
        <?php foreach ($posts as $post) { ?>
            <?php require(JModuleHelper::getLayoutPath('mod_easyblogmostpopularpost', 'list_item')); ?>
        <?php } ?>
    </div>
    <?php } else { ?>
