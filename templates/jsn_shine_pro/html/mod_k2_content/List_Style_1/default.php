...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock k2ListStyle1<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
    ...
    <?php if($key==0) { ?>
  	...
  	<?php } else { ?>
		<?php if($key==1) echo "<ul>"?>
		<li>
			<span class="number-order"><?php echo '0'.$key.'.' ;?></span>
		  	<?php if($params->get('itemTitle')): ?>
			  <a class="moduleItemTitle" href="<?php echo $item->link; ?>"><?php echo $item->title; ?></a>
			<?php endif; ?>
		</li>
		<?php if(count($items)==$key+1) echo "</ul>"; ?>
