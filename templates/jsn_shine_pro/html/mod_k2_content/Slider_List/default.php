...
$document->addScript( $document->baseurl . "/templates/jsn_shine_pro/niches/magazine/js/owl.carousel.min.js" );
?>

<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock k2SliderList<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
	<?php if($params->get('itemPreText')): ?>
	<p class="modulePretext"><?php echo $params->get('itemPreText'); ?></p>
	<?php endif; ?>
  
	<?php if(count($items)): ?>
		<div class="owl-list-k2 owl-carousel">
	...
	<script type="text/javascript">
		jQuery(document).ready(function($) {
		    ...
		    $('#k2ModuleBox<?php echo $module->id; ?> .owl-list-k2').owlCarousel(owl_options);

			$('#k2ModuleBox<?php echo $module->id; ?> .navslider .prev').on('click', function(e){
				e.preventDefault();
				$('#k2ModuleBox<?php echo $module->id; ?> .owl-list-k2').trigger('owl.prev');
			});
			$('#k2ModuleBox<?php echo $module->id; ?> .navslider .next').on('click', function(e){
				e.preventDefault();
				$('#k2ModuleBox<?php echo $module->id; ?> .owl-list-k2').trigger('owl.next');
			});
