...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock k2ListStyle2<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
    ...
    <?php if($key==0 || $key==1) { ?>
	    <?php if($key==0) echo '<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12"><div class="row big-block">'; ?>
		...
		<?php if($key==1) echo '</div></div>'; ?>
  	<?php } else { ?>
  	<?php if($key==2) echo '<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">'; ?>
  	<div class="Item item-small-block<?php if(count($items)==$key+1) echo " lastItem"; ?>">
		  <div class="media">
