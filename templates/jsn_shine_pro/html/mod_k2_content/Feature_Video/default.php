...
?>
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock k2FeatureVideo<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
	...
	<?php if(count($items)): ?>
		<div class="row">
		    <?php foreach ($items as $key=>$item):?>
			    <?php if($key==0 && count($items)>1): ?>
			    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
				<?php endif; ?>
				<?php if($key==2): ?>
			    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 big-item">
				<?php endif; ?>
				<?php if($key==3): ?>
			    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
				<?php endif; ?>
