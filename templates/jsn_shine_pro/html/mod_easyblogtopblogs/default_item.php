...
?>
<div class="mod-item top-trending ">
    ...
    <?php if ($params->get('showratings', true) && $post->showRating) { ?>
        <div class="eb-rating">
            <?php echo EB::ratings()->html($post, 'ebtopblogs-' . $post->id . '-ratings', JText::_('MOD_TOPBLOGS_RATEBLOG'), $disabled); ?>
        </div>
    <?php } ?>
        ...
        <?php if ($params->get('showcommentcount', 0)) { ?>
            <div class="mod-cell pr-10">
                <a href="<?php echo $post->getPermalink();?>">
                    <?php echo EB::string()->getNoun('MOD_TOPBLOGS_COMMENTS', EB::comment()->getCommentCount($post), true);?>
                </a>
            </div>
        <?php } ?>
