...
<form class="form-inline col-sm-10 col-xs-12 " id="productFilters" name="productfilters"  action="<?php echo JRoute::_('index.php');?>" data-link="<?php echo $this->active_menu->link.'&Itemid='.$this->active_menu->id;?>" method="post">
