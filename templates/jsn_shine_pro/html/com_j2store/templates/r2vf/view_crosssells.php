...
<div class="row product-crosssells-container">
	<div class="col-sm-12">
				<h3 class="product-upcross-title"><?php echo JText::_('J2STORE_RELATED_PRODUCTS_CROSS_SELLS'); ?></h3>
				...
				<div class="col-sm-6 col-md-<?php echo round((12 / $columns));?>">
					<div class="crosssell-product">
						...
						<?php
	      				...
	      				?>
		   				<?php if(isset($thumb_image) &&  JFile::exists(JPATH::clean(JPATH_SITE.'/'.$thumb_image))):?>
		   					<a href="<?php echo $cross_sell_product->product_link; ?>"><img alt="<?php echo $cross_sell_product->product_name ;?>" class="j2store-product-thumb-image-<?php echo $cross_sell_product->j2store_product_id; ?>"  src="<?php echo JUri::root().JPath::clean($thumb_image);?>" /></a>
					   	<?php endif; ?>
						...
						<?php if(count($cross_sell_product->options) || $cross_sell_product->product_type == 'variable'): ?>
							<a class="<?php echo $this->params->get('choosebtn_class', 'button btn btn-success'); ?>"
