...
<!-- we have options so we just redirect -->
	<a href="<?php echo $this->product->product_link; ?>" class="<?php echo $this->params->get('choosebtn_class', 'btn btn-success button view-button'); ?>"><i class="fa fa-search"></i><span><?php echo JText::_('J2STORE_VIEW_PRODUCT_DETAILS'); ?></span></a>
