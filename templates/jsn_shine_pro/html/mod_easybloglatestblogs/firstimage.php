...
<div id="fd" class="eb eb-mod mod_easybloglatestblogs <?php echo $params->get('moduleclass_sfx'); ?>  <?php echo $params->get('module_responsive') ? ' eb-responsive' : '';?> firstimage">
		...
		<?php
			...
			foreach ($posts as $post) {
				...
				if ( $i == 0 ) {
					...
					require(JModuleHelper::getLayoutPath('mod_easybloglatestblogs', 'firstimage_item'));

				} else {

					require(JModuleHelper::getLayoutPath('mod_easybloglatestblogs', 'firstimage_list'));
