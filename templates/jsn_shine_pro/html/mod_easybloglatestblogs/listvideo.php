...
<div id="fd" class="eb eb-mod mod_easybloglatestblogs list-video <?php echo $params->get('moduleclass_sfx'); ?>  <?php echo $params->get('module_responsive') ? ' eb-responsive' : '';?>">

	<?php if ($posts) { ?>
	<div class="eb-mod<?php if ($layout == 'horizontal') { echo " mod-items-grid clearfix"; } ?>">
		<?php foreach ($posts as $post) { ?>
			<?php require(JModuleHelper::getLayoutPath('mod_easybloglatestblogs', 'listvideo_item')); ?>
		<?php } ?>
	</div>
	<?php } else { ?>
