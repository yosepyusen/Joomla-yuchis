...
<?php } ?>
	<div class="eb-mod-title">
		<a href="<?php echo $post->getPermalink(); ?>" class="eb-mod-media-title lastest-news"><?php echo $post->title;?></a>
	</div>

<?php } ?>

<?php if (!in_array($post->posttype, array('quote', 'video')) && $params->get('showintro', '-1') != '-1') { ?>
