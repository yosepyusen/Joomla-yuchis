    ...
    <?php } ?>
        ...
        <?php if ($post->posttype == 'video') { ?>
            ...
            <div class="eb-mod-title">
                <a href="<?php echo $post->getPermalink(); ?>" class="eb-mod-media-title"><?php echo substr($post->title, 0 , 20);?></a>
            </div>
        <?php } ?>

        <?php if (in_array($post->posttype, array('twitter', 'email', 'link'))) { ?>
            <div class="eb-mod-title">
                <a href="<?php echo $post->posttype == 'link'? $post->getAsset('link')->getValue() : $url; ?>" class="eb-mod-media-title"><?php echo substr($post->title, 0 , 20);?></a>
            </div>
