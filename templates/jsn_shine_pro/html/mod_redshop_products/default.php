...
for ($i = 0, $in = count($rows); $i < $in; $i++)
{
	...
	echo "<div class=\"mod_redshop_products_image\">";
		if ($image)
		{
			...
			else
			{
				...
				echo "<a href=\"" . $link . "\" title=\"$row->product_name\"><img src=\"" . $thumImage . "\"></a>";
			}
		}
	...
	echo "</div>"; //end div wrapper image


	echo "<div class=\"mod_redshop_products_info\">";	
	...
	echo "</div>"; //end product info (addtocart + price)
