...
<?php foreach ($list as $product_id => $product) : ?>
	...
	<!-- single product -->
	<div class="j2store product-<?php echo $product->j2store_product_id; ?> j2store-module-product span<?php echo round((12 / $total_cols));?> ">
	...
	<div class="product-cart-left-block col-md-8" >	
