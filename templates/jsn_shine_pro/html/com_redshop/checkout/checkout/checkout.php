...
<table style="width: 100%;" border="0" cellspacing="0" cellpadding="0">
	<tbody>
	<tr>
		<td width="50%" valign="top" class="table-checkout">
			<table border="0">
				<tbody>
				<tr>
			...
			<br/></td>
		<td width="50%" align="right" valign="top" class="table-checkout">
			...
			<div class="checkout-div">{newsletter_signup_lbl} {newsletter_signup_chk}</div>
			<div class="checkout-div">{terms_and_conditions:width=500 height=450}</div>
			<div class="checkout-div">{checkout_button}{shop_more}</div>
		</td>
	</tr>
	</tbody>
</table>