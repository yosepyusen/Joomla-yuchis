...
if (strstr($cart_data, "{shop_more}"))
{
	...
	$shop_more = '<input type=button class="btn btn-default shopmore" value="' . JText::_('COM_REDSHOP_SHOP_MORE') . '" onclick="javascript:document.location=\'' . $shopmorelink . '\'">';
...
$empty_cart = '<form style="padding:0px;margin:0px;" name="empty_cart" method="POST" >
		...
		<input type=button class="btn btn-default" value="' . JText::_('COM_REDSHOP_EMPTY') . '" onclick="document.empty_cart.submit();">
		</form>';
