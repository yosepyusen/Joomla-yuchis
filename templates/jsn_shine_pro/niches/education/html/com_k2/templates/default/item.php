...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemBody">
		...
		<?php if(($this->item->params->get('itemExtraFields') && count($this->item->extra_fields)) || ($this->item->params->get('itemAttachments') && count($this->item->attachments))){
			$countcolumn = 4;
		}else $countcolumn = 0; ?>
		<?php if(!empty($this->item->fulltext)): ?>
		<div class="itemText col-xs-12 col-sm-<?php echo ceil(12-$countcolumn)?>">
		...
		<!-- Item text -->
		<div class="itemFullText col-xs-12 col-sm-<?php echo ceil(12-$countcolumn)?>">
			<?php echo $this->item->introtext; ?>
		</div>
		...
		<?php if(($this->item->params->get('itemExtraFields') && count($this->item->extra_fields)) || ($this->item->params->get('itemAttachments') && count($this->item->attachments))): ?>
		<div class="col-xs-12 col-sm-<?php echo $countcolumn ?>">
			...
			<div class="itemAttachmentsBlock">
				<ul class="itemAttachments">
					...
					<li>
						<a class="btn btn-default" title="<?php echo K2HelperUtilities::cleanHtml($attachment->titleAttribute); ?>" href="<?php echo $attachment->link; ?>">
							<div class="title">Download Prospectus</div>
							<div class="file-name"><?php echo $attachment->title; ?></div>
						</a>
