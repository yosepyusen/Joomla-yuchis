	...
	<div class="catItemHeader">
		...
		<div class="jsn-article-toolbar">
			...
			<div class="jsn-article-info">
				...
				<!-- Item Author -->
				<div class="author"><i class="fa fa-user"></i><span class="catItemAuthor"> <a rel="author" href="<?php echo $this->item->author->link; ?>"><?php echo $this->item->author->name; ?></a> </span></div>
				<?php endif; ?>
				<?php if($this->item->params->get('catItemDateCreated')): ?>
				<!-- Date created -->
				<div class="createdate"><i class="fa fa-calendar"></i><span class="catItemDateCreated"> <?php echo JHTML::_('date', $this->item->created , JText::_('K2_DATE_FORMAT_LC2')); ?> </span></div>
				<?php endif; ?>
			</div>
		</div>
		<?php endif; ?>
