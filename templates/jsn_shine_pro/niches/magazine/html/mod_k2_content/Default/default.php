...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock default<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
	  ...
	  <div class="media">
	  		...
	  		<div class="media-left pull-left">
				<a class="" href="<?php echo $item->link; ?>" title="<?php echo JText::_('K2_CONTINUE_READING'); ?> &quot;<?php echo K2HelperUtilities::cleanHtml($item->title); ?>&quot;">
					<img class="media-object" src="<?php echo $item->image; ?>" style="width: 68px" alt="<?php echo K2HelperUtilities::cleanHtml($item->title); ?>" />
				</a>
	  		</div>
			<?php endif; ?>
		      ...
		      <div class="media-heading">
		      	<a class="moduleItemTitle" href="<?php echo $item->link; ?>">
		      		<?php 
		      		if($params->get('moduleclass_sfx') == 'hot-news') {
		      			echo JHTML::_('string.truncate', ($item->title), 50);
		      			if(JString::strlen($item->title) > 50) echo '<span class="read-more"> '.JText::_('K2_READ_MORE_NO_DOT').'</span>';
		      		}
		      		else {
		      			echo $item->title;
		      		}
  ...
  <?php endif; ?>
	...
	<a class="btn btn-default btn btn-default moduleCustomLink" href="<?php echo $params->get('itemCustomLinkURL'); ?>" title="<?php echo K2HelperUtilities::cleanHtml($itemCustomLinkTitle); ?>"><?php echo $itemCustomLinkTitle; ?></a>
	<?php endif; ?>
