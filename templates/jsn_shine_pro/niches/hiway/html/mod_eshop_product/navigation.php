	...
	<div class="image-product">
		...
		foreach ($items as $key => $product)
		{
			...
			$labels = EshopHelper::getProductLabels($product->id);
	 		?>
			<div class="image" style="width: <?php echo (int) 100/$productsPerRow; ?>%">
			...
			<div class="clear"></div>
			<a href="<?php echo $viewProductUrl; ?>" <?php if ($showTooltip) echo 'class="link" data-original-title=" ' . $tooltip . '"'; else echo 'title="' . $product->product_name . '"'; ?>>
