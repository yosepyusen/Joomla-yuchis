...
<div class="eshop-product<?php echo $params->get( 'moduleclass_sfx' ); ?>">
	...
	<ul class="clearfix">
		...
		foreach ($items as $key => $product)
		{
			...
			if ($key%$productsPerRow == 0) echo '<div class="clearfix"></div>';
		 	?>
			<li class="eshop_product" style="width: <?php echo (int) 100/$productsPerRow; ?>%">
				<div class="media">
				  <a class="media-left" href="<?php echo $viewProductUrl; ?>">
						<?php
						...
						?>
						<img class="media-object" alt="<?php echo $product->product_name; ?>" src="<?php echo $image; ?>">
				  </a>
				  <div class="media-body">
				    <a class="product-name" href="<?php echo $viewProductUrl; ?>" <?php if ($showTooltip) echo 'class="product-name link" data-original-title=" ' . $tooltip . '"'; else echo 'title="' . $product->product_name . '"'; ?>>
					...
					if ($showRating)
					{
						...
						<div class="product-review">
							<p>
								<img src="components/com_eshop/themes/jsn_shine/images/stars-<?php echo round(EshopHelper::getProductRating($product->id)); ?>.png" />
							</p>
						</div>
						<?php
					}
