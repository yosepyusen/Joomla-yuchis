...
class plgEditorArkEditor extends JPlugin {
    ...
    public function onInit()
	{
		...
		$result = $dispatcher->trigger('onBeforeLoadToolbar',array( &$params));
		...
		$document->addCustomTag("
			...
			CKEDITOR.on( 'instanceCreated', function( evt ) {
				...
				evt.editor.on( 'configLoaded', function() {
					...
					".($customStylesheetPath ? "this.config.contentsCss.push('".$customStylesheetPath."')" : "")."
    ...
    protected static function importPlugin($type, $plugin = null, $autocreate = true, JEventDispatcher $dispatcher = null)
	{
		static $loaded = array();
