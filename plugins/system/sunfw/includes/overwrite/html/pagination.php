...
function pagination_item_active(&$item)
{
	...
	{
		$display = $item->text;
		$class = ' class="hidden-xs hidden-sm"';
	}
...
function pagination_item_inactive(&$item)
{
	...
	{
		return '<li class="active hidden-xs hidden-sm"><a>' . $item->text . '</a></li>';
	}
	
	// Doesn't match any other condition, render a normal item
	return '<li class="disabled hidden-xs hidden-sm"><a>' . $item->text . '</a></li>';
}
