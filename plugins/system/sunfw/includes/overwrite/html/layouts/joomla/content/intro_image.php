...
<?php if (isset($images->image_intro) && !empty($images->image_intro)) : ?>
	...
	<?php if ($params->get('link_titles') && $params->get('access-view')) : ?>
		...
		<?php if ($images->image_intro_caption) : ?>
			<?php echo 'class="img-responsive caption"' . ' title="' . htmlspecialchars($images->image_intro_caption) . '"'; ?>
		<?php else: ?>
			<?php echo 'class="img-responsive"'; ?>
		<?php endif; ?>
	...
	<?php else : ?><img
		<?php if ($images->image_intro_caption) : ?>
			<?php echo 'class="img-responsive caption"' . ' title="' . htmlspecialchars($images->image_intro_caption, ENT_COMPAT, 'UTF-8') . '"'; ?>
		<?php else: ?>
			<?php echo 'class="img-responsive"'; ?>
		<?php endif; ?>
