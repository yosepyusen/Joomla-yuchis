...
?><a <?php echo $class; ?>href="<?php echo $flink; ?>" <?php echo $title . $rel; ?>><?php echo $icon.$linktype.$description; ?></a><?php
	...
	case 1:
		// _blank
?><a <?php echo $class; ?>href="<?php echo $flink; ?>" target="_blank" <?php
	echo $title . ( empty($rel) ? 'rel="noopener noreferrer" ' : str_replace('rel="', 'rel="noopener noreferrer ', $rel) );
?>><?php echo $icon.$linktype.$description; ?></a><?php
		break;
	case 2:
