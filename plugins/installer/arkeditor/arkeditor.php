...
class PlgInstallerArkeditor extends JPlugin
{
	...
	function onInstallerAfterInstaller ($model, $package, $installer, $result, $msg)
	{
		...
		{
			return JError::raiseError(101,'The Ark Editor component not detected. This means this plugin could not be properly installed and this may affect some operations of the editor');
		}
		...
		if ($element)
		{
			...
			*/
			...
			$manifestTitle 		= $installer->manifest->title;
